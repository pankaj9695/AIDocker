...
const JoinForm = () => {
  ...
  return (
    <form className="flex flex-col justify-center self-stretch text-base text-white font-[450]">
      <header className="w-full flex flex-col text-4xl font-semibold text-center bg-clip-text bg-[linear-gradient(157deg,#FF852D_15.06%,#FF7878_97.93%)] leading-[56px] max-md:max-w-full">
      ...
      <div className="self-center mt-8 tracking-tighter text-center leading-[160%] text-white text-opacity-70 max-md:max-w-full">
      ...
      <div className="flex flex-col justify-center self-center px-12 py-12 mt-5 max-w-full text-lg font-bold tracking-tighter leading-6 rounded-3xl border-2 border-solid backdrop-blur-[6px] bg-white bg-opacity-10 border-white border-opacity-0 w-[700px] max-md:px-5">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            className="shrink-0 my-3 px-5 py-6 focus:outline-none rounded-2xl bg-white text-white text-opacity-50 bg-opacity-10 h-[135px] max-md:max-w-full"
          />
        </div>
        <button
          className="justify-center self-center font-[450] px-7 py-3 mt-11 tracking-normal whitespace-nowrap bg-white shadow-sm leading-[120%] rounded-[30px] text-neutral-900 max-md:px-5 max-md:mt-10"
          type="submit"
