...
const Earning = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-white font-FBlack  font-bold text-3xl sm:text-4xl text-center sm:text-start sm:leading-[52px] tracking-tighter mt-2 pb-1 sm:mt-3.5 max-md:max-w-full">
        Monetize Your AI Innovations and Contributions
      </div>
      ...
      <div className="self-stretch font-FBook text-white text-opacity-70 text-center text-[1.15rem] font-[450]  leading-6 sm:leading-8 tracking-tighter w-full mt-1 max-md:max-w-full">
        AI Enthusiasts can earn revenue, making AiDocker a mutually beneficial
      </div>
