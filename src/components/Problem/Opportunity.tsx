  ...
  return (
    ...
    >
      ...
      {/* <div className="sm:w-6/12 w-full">
        <div className="self-stretch leading-[44px]  text-white text-center sm:text-start text-3xl sm:text-4xl font-bold sm:leading-[56px] tracking-tighter w-full  max-md:max-w-full">
          <span className="heading-gradient ">Opportunity</span>
        </div>
      ...
      <div className="my-3.5 max-md:max-w-full">
        <div className="gap-5 flex  items-baseline max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex  flex-col items-stretch  w-6/12  max-md:w-full max-md:ml-0">
            <h1 className="text-white text-2xl sm:text-4xl text-center sm:text-start font-medium leading-8 sm:leading-[52px] tracking-tighter max-md:max-w-full max-md:mt-5 mt-10">
              Harnessing the Power of GPUs and Data for AI Breakthroughs
            </h1>
          </div>
          <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
            <p className="text-white text-opacity-70 text-[1.15rem]  sm:leading-8 leading-6 tracking-normal sm:tracking-tight text-center sm:text-start font-[450]  my-auto max-md:max-w-full  mt-5 sm:mt-0">
