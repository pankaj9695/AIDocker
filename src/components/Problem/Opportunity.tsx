...
const Opportunity = () => {
  return (
    <motion.section
      ...
      // animate="animate"
      whileInView={"animate"}
      className=" flex items-baseline justify-between shadow-sm bg-white bg-opacity-10  flex-row px-16 sm:py-12 py-6 rounded-3xl max-md:px-5"
    >
      ...
      <div className="w-6/12">
        <div className="self-stretch leading-[44px]  text-white text-4xl font-bold sm:leading-[56px] tracking-tighter w-full  max-md:max-w-full">
          <span className="heading-gradient ">Opportunity</span>
        </div>
