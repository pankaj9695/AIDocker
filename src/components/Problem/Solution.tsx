...
const Solution = () => {
  return (
    <section id="about" className="items-start self-stretch flex flex-col">
      ...
      <div className="self-stretch w-full mt-2 sm:mt-16 px-0 sm:px-5 max-md:max-w-full max-md:mt-10">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          ...
          >
            <div className="justify-center items-center backdrop-blur-[22px] bg-white bg-opacity-10 flex grow flex-col w-full p-1 sm:p-2 rounded-3xl border-2 border-solid border-white border-opacity-0 max-md:mt-5">
              <span className="justify-center self-stretch flex flex-col pt-4 px-4 sm:pt-8 sm:px-8 items-start max-md:px-5">
                <img
                  loading="lazy"
              ...
              <img
                ...
                className="aspect-square object-contain object-center w-7 overflow-hidden max-w-full mt-2 sm:mt-5"
              />
              <motion.span
